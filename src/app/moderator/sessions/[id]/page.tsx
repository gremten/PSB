...
export default async function SessionSummaryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const interaction = calculateSessionInteractionMetrics(snapshot.session, snapshot.events);
