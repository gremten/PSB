...
| Cashback disconnected | Live screen `2072:16263` | Benefit reading in two-row bento, start category connection, FAQ | `public/figma/cashback/partner-*.svg` | `cashback.connect.*`, `cashback.faq.*` |
