...
| Cashback connected | Screen `2125:27598`; new-period live variant `2072:24153` | Current/annual segment, next-month state and category entry | existing `public/figma/home/banner-new-bg.svg` visual-affair asset | `cashback.period.*`, `cashback.next_month.*` |
