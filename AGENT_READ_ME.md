...
- The card carousel follows horizontal pointer movement and changes the active card only after crossing half the 336 px card-to-card travel (168 px); shorter drags animate back. Preserve tap/keyboard flip and `card.*` tracking. Draggable cards and home account-scroller cells must not shrink on press.
